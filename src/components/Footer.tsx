        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              />
              <span className="text-white text-xl font-playfair font-bold">Ак Калфак</span>
            </div>
            <p className="text-white/80 mb-6">
              Татарская общественная организация, посвященная сохранению и развитию национальной культуры, языка и традиций.
            </p>
          ...
          <div>
            <h3 className="text-xl font-playfair font-bold mb-6">Быстрые ссылки</h3>
            <ul className="space-y-3">
              ...
              <li>
                <a href="#news" className="text-white/80 hover:text-white transition-colors flex items-center">
                  <Icon name="ChevronRight" className="w-4 h-4 mr-2" />
                  Новости
                </a>
              </li>
              <li>
                <a href="#gallery" className="text-white/80 hover:text-white transition-colors flex items-center">
                  <Icon name="ChevronRight" className="w-4 h-4 mr-2" />
                  Галерея
                </a>
              </li>
              <li>
                <a href="#contacts" className="text-white/80 hover:text-white transition-colors flex items-center">
                  <Icon name="ChevronRight" className="w-4 h-4 mr-2" />
                  Контакты
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                <Icon name="MapPin" className="w-5 h-5 mr-3 flex-shrink-0 mt-1" />
                <span className="text-white/80">
                  ул. Примерная, 123, г. Казань, 420000
                </span>
              </li>
              <li className="flex">
          ...
          <div>
            <h3 className="text-xl font-playfair font-bold mb-6">Будьте в курсе</h3>
            <p className="text-white/80 mb-4">
              Подпишитесь на нашу рассылку, чтобы получать новости о событиях и мероприятиях.
            </p>
